...
tinyMCE.init({
    ...
    language:           "en",
    relative_urls:      false,
    plugins:            'advimage,advlink,fullscreen,paste,media,grappelli,grappelli_contextmenu',
    ...
    theme_advanced_buttons1: "bold,italic,underline,|,bullist,numlist,blockquote,|,link,unlink,image,charmap,|,undo,redo,|,code,cleanup,|,grappelli_documentstructure,fullscreen,grappelli_adv",
    theme_advanced_buttons2: "formatselect,styleselect",
    theme_advanced_buttons3: "",
    theme_advanced_path: false,
    theme_advanced_blockformats: "p,h4,pre",
